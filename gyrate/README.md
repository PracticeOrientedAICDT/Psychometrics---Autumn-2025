...
Orgainised workspace for IRT analysis for the Gyrate game in Python and R, including data, preprocessing, visualization, simulation, and Computer Adaptive Testing (CAT).
