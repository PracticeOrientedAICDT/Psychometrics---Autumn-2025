...
Orgainised workspace for IRT analysis for the WordMatch game in Python and R, including data, preprocessing, visualization, simulation, and Computer Adaptive Testing (CAT).
